...
from app.database import engine, Client as DBClient, Location as DBLocation, Order as DBOrder, Truck as DBTruck, Route as DBRoute, Cargo as DBCargo, Package as DBPackage, CargoType
