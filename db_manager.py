#!/usr/bin/env python3
"""
Unified Database Manager for Digital Freight Matcher
Consolidates initialization logic from existing scripts with safe duplicate prevention.
"""
...
class SystemStatus:
    ...
    def __init__(self):
        ...
        self.truck_utilization: float = 0.0
        self.active_contracts: int = 0
        self.last_updated: datetime = datetime.utcnow()
        self.clients: int = 0
        self.locations: int = 0
        self.trucks: int = 0
        self.orders: int = 0
        self.cargo_loads: int = 0
        self.packages: int = 0
...
class DatabaseManager:
    ...
    def get_system_status(self) -> SystemStatus:
        ...
        try:
            ...
            status.locations = counts['locations']
            status.trucks = counts['trucks']
            status.total_routes = counts['routes']
